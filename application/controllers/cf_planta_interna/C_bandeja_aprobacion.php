...
class C_bandeja_aprobacion extends CI_Controller {
    ...
    public function index() {
	    ...
	    if($idUsuario != null){           
            ...
            $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PLANTA_INTERNA_PADRE, null, ID_APROBACION_PIN_HIJO, null);
        ...
        //    $data['tablaAprobacionPin'] = $this->getTablaAprobacion(NULL, NULL, array(ID_ESTADO_PLAN_DISENIO, ID_ESTADO_PLAN_PDT_OC));
            $data['json_bandeja'] = $this->getArrayPoAprobBaCoti($this->m_utils->getPlanobraAll(null, null, array(2), null, ID_TIPO_PLANTA_INTERNA));
            $this->load->view('vf_planta_interna/v_bandeja_aprobacion',$data);        	  
    	 }else{
