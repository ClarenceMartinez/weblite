...
class C_registro_po_mo extends CI_Controller {
	...
	//		$data['modulosTopFlotante'] = _getModulosFlotante();
            $this->load->view('vf_consulta/v_registro_po_mo',$data);        	  
    	 }else{
    ...
    public function getFormatoExcelCarga() {
        ...
        try {
            ...
            $data['nombreArchivo'] = 'modelo_carga_registro_po_mo_' . date("YmdHis") . '.xls';
    ...
    public function registrarPoMo()
    {
        ...
        try {
            ...
            $data = $this->m_utils->registrarPo($dataPo, $arrayDetPo, $dataLogPO);
