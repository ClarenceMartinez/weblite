...
class C_detalle_consulta extends CI_Controller {
    ...
    function getInfoITemplanByCod(){
        ...
        try {
            ...
            $data['htmlTabGestion'] = $this->getTabEstadosItemplan($itemplan); 
    ...
    function getTabEstadosItemplan($itemplan) {
        ...
        $html = '<div class="col-auto">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link '.$navActiveDiseno.'" id="v-pills-profile-tab" data-toggle="pill" href="#cont_tab_diseno" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                            <i class="fal fa-chevron-right"> DISEÑO</i>                        
                        </a>
                        <a class="nav-link '.$navActiveLic.'" id="v-pills-messages-tab" data-toggle="pill" href="#cont_tab_lic" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                            <i class="fal fa-chevron-right"> LICENCIA</i>                            
                        </a>
                        <a class="nav-link '.$navActiveAprob.'" id="v-pills-settings-tab" data-toggle="pill" href="#cont_tab_aprob " role="tab" aria-controls="v-pills-settings" aria-selected="false">
                            <i class="fal fa-chevron-right"> APROBACION</i>                        
                        </a>                       
                        <a class="nav-link '.$navActiveObraPreliq.'" id="v-pills-settings-tab" data-toggle="pill" href="#cont_tab_pre_liqui" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                        ...
                        <a class="nav-link '.$navActiveTerminado.'" id="v-pills-settings-tab" data-toggle="pill" href="#cont_tab_terminado " role="tab" aria-controls="v-pills-settings" aria-selected="false">
 ...
 //log_message('error',$html);
    ...
    function getTabVerticalEstacion($itemplan,$infoItem) {
        ...
        if($infoItem['idEstadoPlan']    ==  7){//DISENO EJECUTADO
