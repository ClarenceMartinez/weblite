...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">CREACION MASIVA ORDEN COMPRA COTIZACION B2B</label>                                        
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                        <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="cargarFile()" id="btnRegPO" style="margin-top: 25px;color:white">ATENDER COTIZACIONES</button>
                                    </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_orden_compra/jsAtenMasivoOCB2b.js?v=<?php echo time();?>"></script>
        <script>
