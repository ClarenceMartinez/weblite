...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">ATENCION MASIVA SOLICITUD CERTIFICACION DE ORDEN DE COMPRA DISEÑO</label>                                        
        ...
        <script src="<?php echo base_url(); ?>public/js/js_orden_compra/jsAtenMasivoSolCertiOcDiseno.js?v=<?php echo time();?>"></script>
        <script>
