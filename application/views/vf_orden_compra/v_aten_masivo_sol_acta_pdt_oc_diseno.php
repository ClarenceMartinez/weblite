...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">  
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">ACTUALIZACION DE ESTADO ORDEN DE COMPRA DISEÑO PENDIENTE DE ACTA > PENDIENTE </label>                                        
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                        <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="cargarFile()" id="btnRegPO" style="margin-top: 25px;color:white">ATENDER SOLICITUDES</button>
                                    </div>
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                        (*) La estructura del archivo debe estar en formato .xls o .xlsx(Excel), Puede descargar un ejemplo de la estructura.
                                        <a onclick="exportarFormatoCargaMasivaSolOcCrea()" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                    </div>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h5 id="tituTbObs" style="color:red; display: none; text-align: center;">Cantidad de registros a subir: 100</h5>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_orden_compra/jsAtenMasivoSolacta_pdtOcDiseno.js?v=<?php echo time();?>"></script>
        <script>
