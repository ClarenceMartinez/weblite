...
<head>
        <html lang="en"  class="root-text-sm"> 
        <title>
            PangeaCo | CONSULTA BANDEJA DE EXCESOS
        </title>  
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                        ...
                                        <div class="panel-content">      
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="txtItemplan" placeholder="" data-inputmask="'mask': '99-9999999999'" maxlength="20">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                <button class="btn btn-primary" onclick="filtrarTabla()" id="btnFiltro" style="margin-top: 23px;">CONSULTAR</button>
        ...
        <div class="modal fade" id="modDetalleSolicitud"  tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
							...
							<div class="form-group">
								...
								<div id="contTablaSolicitud" class="form-group table-responsive">
								</div>
							</div>
                        </div>
                    </div>
		...
		<div class="modal fade" id="modAtenderSolicitud" tabindex="-1">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="contCostoFinal" class="form-group" style="display: none">
                                    <label>COSTO FINAL:</label>
                                    <input id="costoFinal" type="text" class="form-control input-mask cosFi" autocomplete="off">    
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>COMENTARIO:</label>
                                    <textarea maxlength="25000" id="inputComentario" class="form-control input-mask" rows="4"></textarea>                     
                                </div>
                            </div>
							<div class="col-sm-12" style="display:none;">
                                <div class="form-group">
                                    <label>PEP1:</label>
                                    <input id="inputPep1" type="text" class="form-control input-mask cosFi" autocomplete="off">                      
                                </div>
                            </div>
							<div class="col-sm-12" style="display:none;">
                                <div class="form-group">
                                    <label>PEP2:</label>
                                    <input id="inputPep2" type="text" class="form-control input-mask cosFi" autocomplete="off">                        
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link attSol">Continuar</button>
        ...
        <script>
            ...
            function openMdlDetalleExceso(component) {
                var jsonData = $(component).data();
                var id_solicitud = jsonData.id_solicitud;
                var origen       = jsonData.origen;
        ...
        $(".attSol").on('click', function (event) {
            ...
            var pep1 = $('#inputPep1').val().trim();
            var pep2 = $('#inputPep2').val().trim();
            ...
            if (accion === 1 && costoFinal < costoFinIni) {
                mostrarNotificacion(1,'error', 'Costo Final no valido, debe ingresar un costo mayor o igual al Solicitado: S/.' + formatearNumeroComas(costoFinIni));
                //alert('Costo Final no valido, debe ingresar un costo mayor o igual al Solicitado: S/.'+formatearNumeroComas(costoFinIni));
                return;
            }
            if (comentario === '') {
                mostrarNotificacion(1,'error', 'Debe Ingresar un comentario');
            ...
            swal.fire({
                ...
                $.ajax({
                    ...
                    if (data.error == 0) {
                        ...
                        mostrarNotificacion(1,'error', data.msj);
                    }
                });
            }, function (dismiss) {
