    ...
    <body class="<?php echo ESTILO_BODY ?>">
                    ...
                    <div class="modal-body">                       
                        <div class="form-group row">       
                            <div class="col-3 pr-1">
                                <label class="col-xl-12 form-label" for="txtItemplan">ITEMPLAN</label>
                                <input type="text" id="txtItemplan" name="txtItemplan" class="form-control" placeholder="" required>
                                <div class="invalid-feedback">No, you missed this one.</div>
                            </div>                         
                            <div class="col-3 pr-1">
                                <label class="col-xl-12 form-label" for="txtpep1">PEP 1</label>
                                <input type="text" id="txtpep1" name="txtpep1" class="form-control" placeholder="" required maxlength="20">
                                <div class="invalid-feedback">No, you missed this one.</div>
                            </div>
                            <div class="col-3 pl-1">
                                <label class="col-xl-12 form-label" for="txtpep2">PEP 2</label>
        ...
        <script>    
            ...
            {  
                ...
                if(txtItemplan  ==  null    ||  txtItemplan ==  ''){
                    Swal.fire('Debe Ingresar ITEMPLAN.');
                    return;
                }
