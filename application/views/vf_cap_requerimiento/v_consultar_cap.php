...
<body class="mod-bg-1 mod-nav-link ">
            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Consultar Cap</li>
                    </ol>
                    <div class="subheader">
                        ...
                        <div class="col-xl-12">
                            <div id="panel-1" class="panel">
                                ...
                                <div class="panel-container show">
                                    <div class="panel-content" id="modalRespuesta">
                                        <?php echo $tablaRequerimiento ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade moda-sm" id="mdlRequerimientoRes" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body container">
                                    <div class="settings-panel">
                                        <div id="respuestaRequerimiento" class="form-group">

                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary" onclick="ingresarRespuesta()"><i class="fal fa-save"></i> Guardar</button>
    ...
    <script src="<?php echo base_url(); ?>public/js/js_cap_requerimiento/jsConsultarCap.js?v=<?php echo time(); ?>"></script>
    <script>
        $(document).ready(function() {
            initDataTable('tbRequerimiento', 2);
        });
    </script>
</body>
<!-- END Body -->
