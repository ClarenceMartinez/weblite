    ...
    <body class="<?php echo ESTILO_BODY ?>">
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-3 col-lg-9 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">REGISTRO MASIVO DE OBRAS</label>                                        
        ...
        <script type="text/javascript">
            ...
            function descargarFormatoExcel(){
                $.ajax({
                        type  :	'POST',
                        url   :	'getFormatoCargaMasivaCVAll',
                        data  :	{ },
                        dataType:"html",//html
                    ...
                    if(data.error == 0){
                        if(data.archivo != null && data.archivo != undefined){
                            ...
                            $("body").append($a);
                            $a.attr("download","FORMATO_CARGA_MASIVA_IP.xls");
                            $a[0].click();
                            $a.remove();
                        }
                    }else{
					...
					if (result.value) {
						...
						$.ajax({
							...
							if(data.error == 0){
                                ...
                                swal.fire('Aviso',data.msj,'success');
                                return;
							}else{
