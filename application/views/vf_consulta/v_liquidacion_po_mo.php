...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                ...
                                <div class="panel-content" style="margin-top: -20px;">                         
                                    <div class="row">                          
                                            ...
                                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <label class="form-label" for="inputGroupFile01">CODIGO DE OBRA: <?php echo isset($itemplan) ? $itemplan : null ?> <br> ESTACION: <?php echo isset($estacionDesc) ? $estacionDesc : null ?></label>                                        
                                                
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="form-control-file border-left-0 bg-transparent pl-0" name="archivo" id="archivo" accept="application/vnd.ms-excel,application/vnd.openxmlformats-offedocument.spreadsheetml.sheet.">
                                                    ...
                                                    <div class="input-group-append">
                                                        ...
                                                        <button type="button" class="btn btn-outline-primary waves-effect waves-themed" onclick="cargarExcelPO()" id="btnProcesar">
                                            ...
                                            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="text-align: center;    margin-top: 15px;">
                                                <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="registrarPO()" id="btnRegPO" style="margin-top: 25px;color:white">EDITAR PO MO</button>
                                            </div>
                                            <?php if($showBtnLiqui){?>
                                                <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="text-align: center;    margin-top: 15px;">
                                                    <button class="btn btn-warning ml-auto waves-effect waves-themed" type="button" onclick="liquidarPoMo()" id="btnRegPO" style="margin-top: 25px;color:white">LIQUIDAR MO</button>
                                                </div>
                                            <?php } ?>
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                (*) La estructura del archivo debe estar en formato .xls o .xlsx(Excel), Puede descargar un ejemplo de la estructura.
                                                <a onclick="expotarFormatoCargaPO()" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                            </div>
                                            ...
                                            <div class="panel-container show">
                                                <div class="panel-content">
                                                    <div class="">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div id="cont_tb_po" class="table-responsive">
                                                                <!-- inicio cont tb po-->
                                                                    <?php echo isset($tablaPO) ? $tablaPO : null ?>
                                                                <!-- fin cont tb po -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row" id="ctnDetalleCosto" style="display:none;">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="table-scale-border-top border-left-0 border-right-0 border-bottom-0">
                                                                            ...
                                                                            <td class="text-right keep-print-font">
                                                                                <h4 class="m-0 fw-700 h2 keep-print-font" id="costoTolalPo">S/.7,477.36</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
        ...
        <script>
            ...
            var itemplanGlob = '<?php echo isset($itemplan) ? $itemplan : null ?>';
            var idEstacionGlob = <?php echo isset($idEstacion) ? $idEstacion : null ?>;
            var codigo_poGlob = '<?php echo isset($codPo) ? $codPo : null ?>';
        </script>
        <script src="<?php echo base_url(); ?>public/js/js_consulta/js_liquidacion_po_mo.js?v=<?php echo time();?>"></script>
    </body>
    <!-- END Body -->
</html>
