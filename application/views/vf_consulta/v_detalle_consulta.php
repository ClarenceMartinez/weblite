...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                                        ...
                                                        <div class="tab-content p-3">
                                                            <div class="tab-pane fade show active" id="tab_detalle" role="tabpanel">
                                                                <div class="row no-gutters" style="font-weight: bold;margin-left: 10px;">                                                                     
                                                                    ...
                                                                    <div class="col-lg-6 col-xl-6 col-12 text-left py-1 d-none content-oc-diseno"> 
                                                                        <a class="text-muted mb-0"></a>
                                                                        <a style="color: var(--theme-primary);" id=""></a>
                                                                    </div>
                                                                    <div class="col-lg-6 col-xl-6 col-12 text-left py-1 d-none content-oc-diseno" > 
                                                                        <a class="text-muted mb-0">ORDEN DE COMPRA DISEÑO : </a>
                                                                        <a style="color: var(--theme-primary);" id="txt_orden_compra_diseno"></a>
                                                                    </div>
                                                                    <div class="col-lg-6 col-xl-6 col-12 text-left py-1">  
            ...
            $('.searchT').on('click', function() {
                ...
                $.ajax({
                    ...
                    var data = JSON.parse(data);
                        $('#txt_orden_compra_diseno').html("");
                        $(".content-oc-diseno").addClass('d-none');
					if (data.error == 0) {
                        ...
                        if (data.dataObra.idProyecto == 52)
                        {
                            $('#txt_orden_compra_diseno').html(data.dataObra.orden_compra_diseno);
                            $(".content-oc-diseno").removeClass('d-none');
        ...
        <script type="text/javascript">
            jQuery(document).on('click', '.classpending',function(e)
            {
                e.preventDefault();
                var _this = $(this);
                var msg = _this.attr('data-msg');
                // mostrarNotificacion(1, 'error', 'Error', 'El Itemplan actual, está en estado Prediseño');
                mostrarNotificacion(1, 'error', 'Error', msg);
            })
        </script>
    </body>
    <!-- END Body -->
