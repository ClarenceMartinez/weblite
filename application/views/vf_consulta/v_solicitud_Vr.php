...
<head>
        ...
        <link rel="stylesheet" media="screen, print" href="<?php echo base_url();?>public/css/notifications/sweetalert2/sweetalert2.bundle.css?v=<?php echo time();?>">
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <div class="input-group bg-white shadow-inset-2">
                                                        ...
                                                        <input type="text" class="form-control border-left-0 bg-transparent pl-0" id="txtItemplan" placeholder="" maxlength="25" required>
                                                    </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="selectPO">CÓDIGO PO<span class="text-danger">*</span></label>
                                                    <select id="selectPO" name="selectPO" class="select2 form-control w-100" onchange="getInfoPo(this);">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="txtVR">VALE DE RESERVA</label>
                                                    <input type="text" class="form-control" id="txtVR" placeholder=""  readonly required>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="txtEECC">EECC</label>
                                                    <input type="text" class="form-control" id="txtEECC" placeholder=""  readonly required>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="txtJefatura">JEFATURA</label>
                                                    <input type="text" class="form-control" id="txtJefatura" placeholder=""  readonly required>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="txtCentro">CENTRO</label>
                                                    <input type="text" class="form-control" id="txtCentro" placeholder=""  readonly required>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="txtAlmacen">ALMACÉN</label>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-label="" placeholder="" id="txtAlmacen" readonly required>
                                            ...
                                            <div id="contTabla" style="display:none;">
                                                <div class="row mb-3">
                                                    <div class="col-sm-3 col-md-3">
                                                        <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="getKitMaterial()" id="btnKit">AÑADIR MATERIAL</button>
                                                    </div>
                                                </div>
		...
		<div class="modal fade modal-fullscreen" id="modalKitMaterial" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="overflow: scroll;">
                    <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center w-100 form-group">
                        <h4 class="m-0 text-center color-white" id="titModalKitMaterial">
                            KIT MATERIAL
                    ...
                    <div class="modal-body">
                        <div class="settings-panel">
							<div id="contTablaKitMat" class="form-group">
        ...
        <script src="<?php echo base_url(); ?>public/js/loading/jquery.loading.min.js?v=<?php echo time();?>"></script>
        <script src="<?php echo base_url(); ?>public/js/jquery.numeric/jquery.numeric-min.js?v=<?php echo time();?>s"></script>
        <script src="<?php echo base_url(); ?>public/js/notifications/sweetalert2/sweetalert2.bundle.js"></script>
        <script src="<?php echo base_url(); ?>public/js/Utils.js?v=<?php echo time();?>"></script>
        <script src="<?php echo base_url(); ?>public/js/js_consulta/jsSolicitud_Vr.js?v=<?php echo time();?>"></script>
        <script>
