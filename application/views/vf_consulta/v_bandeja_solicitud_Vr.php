...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                        ...
                                        <div class="panel-content">
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="txtItemplan" placeholder="" maxlength="20">
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="selectJefaturaSap">JEFATURA</label>
                                                    <?php echo isset($cmbJefaturaSap) ? $cmbJefaturaSap : null; ?>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="selectEECC">EECC</label>
                                                    <?php echo isset($cmbEECC) ? $cmbEECC : null; ?>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="selectFase">FASE</label>
                                                    <?php echo isset($cmbFase) ? $cmbFase : null; ?>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="selectEstadoSolVr">Estado Atención</label>
                                                    <?php echo isset($cmbEstadoSolVr) ? $cmbEstadoSolVr : null; ?>
                                                    <div class="valid-feedback">
                                                        Correcto!
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group" align="center">
                                                <button class="btn btn-primary" onclick="filtrarTabla()" id="btnFiltro">CONSULTAR</button>
                                            </div>
                                            -->
                                            <hr>
                                            <div id="contTablaSolVR">
		...
		<div class="modal fade modal-fullscreen" id="modalDetalleSolVr" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="overflow: scroll;">
                    <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center w-100 form-group">
                        <h4 class="m-0 text-center color-white" id="titModalDetalleSolVr">
                            DETALLE SOLICITUD
                    ...
                    <div class="modal-body">
                        <div class="settings-panel">
							<div id="contTablaDetSolVr" class="form-group">
        ...
        <script src="<?php echo base_url(); ?>public/js/js_consulta/jsBandejaSolicitud_Vr.js?v=<?php echo time();?>"></script>
        <script>
            ...
            function filtrarTabla(){
                ...
                var idJefaturaSap = $('#selectJefaturaSap').val();
                var idEECC = $('#selectEECC option:selected').val();
                var idFase = $('#selectFase option:selected').val();
                var estado = $('#selectEstadoSolVr option:selected').val();
                //console.log(estado);
                $.ajax({
                    type  :	'POST',
                    url   :	'getBandejaSolVrByFiltros',
                    data  :	{ 
                        itemplan : itemplan,
