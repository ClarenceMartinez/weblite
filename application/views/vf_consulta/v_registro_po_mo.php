...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                ...
                                <div class="panel-content" style="margin-top: -20px;">                         
                                    <div class="row">                          
                                            ...
                                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                                <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="registrarPO()" id="btnRegPO" style="margin-top: 25px;color:white">CREAR PO MO</button>
                                            </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_consulta/js_registro_po_mo.js?v=<?php echo time();?>"></script>
    </body>
    <!-- END Body -->
</html>
