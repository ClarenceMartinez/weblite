    ...
    <body class="<?php echo ESTILO_BODY ?>">
                            ...
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr form-group">
                                        <h2>
                                                CONSULTA DE EVIDENCIAS LICENCIA
                                        </h2>
                                        ...
                                        <div class="panel-content">             
                                            ...
                                            <div class="row" style="-20px;">     <!--                                                     
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-6">  
                                                    ...
                                                    <select class="select2" id="cmbProyecto" aria-label="usertype"> 
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-6">  
                                                    ...
                                                    <select class="select2" id="cmbEstadoPlan" aria-label="usertype">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-sm table-hover table-striped w-100">
                                                    <thead class="bg-primary-600"">                                                       
                                                        <th style="width:80px !important">FILES</th> 
                                                        <th>ITEMPLAN</th>                            
                                                        <th>PROYECTO</th>
                                                        <th>SUBPROYECTO</th>
                                                        <th>INDICADOR</th>
        ...
        <script>
            ...
            $('.searchT').on('click', function() {
                ...
                var idEstadoPlan    = $.trim($('#cmbEstadoPlan').val());
