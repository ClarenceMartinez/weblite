...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">REGISTRO PO MATERIAL CODIGO DE OBRA: <?php echo isset($itemplan) ? $itemplan : null ?></label>                                        
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                        <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="registrarPO()" id="btnRegPO" style="margin-top: 25px;">CREAR PO MAT</button>
                                    </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_consulta/js_registro_manual_po_mat.js?v=<?php echo time();?>"></script>
    </body>
    <!-- END Body -->
</html>
