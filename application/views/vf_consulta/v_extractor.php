...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                                        ...
                                        <div class="panel-content">
                                                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            <img src="<?php echo base_url(); ?>public/img/iconos/doc_excel.png" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:3rem; height: 3rem; background:green;">
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    OBRAS
                                                                ...
                                                                <a class="text-info fs-sm" onclick="descargarPlanobraCV()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                        SEGUIMIENTO DE OBRAS CV
                                                                    <small class="m-0 fw-300">
                                                                       Reporte Detalle Seguimiento CV
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="descargarPlanobraDetHijosCV()()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    SEGUIMIENTO DE OBRAS B2B
                                                                    <small class="m-0 fw-300">
                                                                       Reporte Detalle Seguimiento B2B
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="descargarPlanobraDetHijosB2b()()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        <!--
                                                        <div style="display:none" class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            <img src="<?php echo base_url(); ?>public/img/iconos/doc_excel.png" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem; background:green;">
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    DETALLE PO MAT
                                                                    <small class="m-0 fw-300">
                                                                        Fec: <?php echo date('Y-m-d H:i:s'); ?>
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="descargarDetallePoMat()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        -->
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                ...
                                                                <a class="text-info fs-sm" onclick="descargarDetallePlanCV()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
														<div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    ORDEN DE COMPRA
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Solicitudes OC
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="descargarSolicitudOc()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    DETALLE PO MATERIALES
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Po Materiales
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="decargarDetalleMat()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
														 <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    DETALLE PO MANO DE OBRA
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Po MO
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="decargarDetalleMo()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
														<div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    COTIZACIONES B2B
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Cotizaciones
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="decargarCotizacionesB2b()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
														<div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    DETALLE LICENCIAS
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Licencias
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="decargarDetLicencias()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
														<div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                <h5 class="m-0">
                                                                    FORMULARIO REFORZAMIENTOS CTO
                                                                    <small class="m-0 fw-300">
                                                                        Reporte Detalle Formulario Reforzamiento CTOS
                                                                    </small>
                                                                </h5>
                                                                <a class="text-info fs-sm" onclick="decargarDetFormRefCto()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        if ($idEmpresaColab == 6)
                                                        {
                                                            ...
                                                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                                ...
                                                                <div class="ml-2 mr-3">
                                                                    ...
                                                                    <a class="text-info fs-sm" onclick="decargarDetMatrizSeguimiento()" style="cursor:pointer">Descargar</a> -
                                                                    <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                                </div>
                                                            </div>
                                                            <?php
                                                        ...
                                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                ...
                                                                <a class="text-info fs-sm" onclick="decargarDetMatrizJumpeo()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <!-- <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                                            ...
                                                            <div class="ml-2 mr-3">
                                                                ...
                                                                <a class="text-info fs-sm" onclick="decargarDetMatrizPinPex()" style="cursor:pointer">Descargar</a> -
                                                                <a href="javascript:void(0)" class="text-info fs-sm" title="Descargar"><i class="fal fa-download"></i></a>
                                                            </div>
                                                        </div> -->
                                                    </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_consulta/jsExtractor.js?v=<?php echo time();?>"></script>
        <script>
