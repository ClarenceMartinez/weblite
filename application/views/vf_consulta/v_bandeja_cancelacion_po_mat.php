...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
        ...
        <script>
			...
			function getReporteMateriales(component){
                ...
                $.ajax({
                        type  :	'POST',
                        url   :	'getMaterialesByPoBanAprobCan',
                        data  :	{ 
    ...
    function cancelarPoMatConfirmacion(btn) {
        ...
        Swal.fire({        
            title: 'Cancelar Po Material',
            html: 'Esta seguro de cancelar la PO?',
            icon: 'warning',
            html: '<div class="form-group">'+
                    ...
                    '</div>',
            showCancelButton: true,        
            confirmButtonText: 'Si, cancelar la PO!',
            ...
            if (result.value) {
                ...
                var formData = new FormData();
                formData.append('codigo_po', codigo_po);
