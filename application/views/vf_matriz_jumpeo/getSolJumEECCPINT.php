                            ...
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr form-group">
                                        <h2>Bandeja de Atención de Solicitud de JUMPEO</h2>
                                        
                                    </div>
                                    <div class="panel-container show">     
                                        <div class="panel-content">

                                            <div class="row mb-3" style="-20px;">                                              
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-6">
                                                    <a style="" class="btn btn-md btn-outline-primary waves-effect waves-themed searchT mt-4" id="btnBuscarCodigoSolicitudEECCPIN">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button id="btn-guardar-x2"  class="btn btn-success">Jumpear</button>
                            <button class="btn-dismis-modal-x btn btn-danger" data-dismiss="modal">cerrar</button>
                        </div>
                    </div>
                </div>
            </div>
