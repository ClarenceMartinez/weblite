                                        ...
                                        <div class="panel-content">
                                            <div class="row">
                                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <label class="form-label" for="inputGroupFile01">CARGA MASIVA PIN PEX</label>                                        
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <button type="button" class="btn btn-outline-primary waves-effect waves-themed" onclick="procesarFilePinPex()" id="btnProcesar">
                                                ...
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <center>
                                                        ...
                                                        {
                                                            echo '<b style="color:red; font-size:15px;">  fecha ultima actualizacion del reporte pin pex: '.$fechaRegistro.'</b>';
                                                        }
                                                        ?> 
                                                    </center>
                                                </div>
