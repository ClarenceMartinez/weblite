                                        ...
                                        <div class="panel-content">
                                            <div class="row">
                                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <label class="form-label" for="inputGroupFile01">CARGA MASIVA MATRIZ JUMPEO</label>                                        
                                                    
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" class="form-control-file border-left-0 bg-transparent pl-0" name="archivo" id="archivo" accept=".xlsx">
                                                ...
                                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                                    <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="cargarFile()" id="btnRegPO" style="margin-top: 25px;color:white">REGISTRAR VALORES</button>
                                                </div>
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                    (*) La estructura del archivo debe contener 8 columnas (GESTOR, FASE, ETAPAS, ITEMPLAN, NODO, CABLE, HILO, DISTRITO) en formato .csv delimitado por ";" Puede descargar un ejemplo de la estructura.
                                                    <a onclick="exportarFormatoCargaMatrizJumpeo()" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                                   <!-- -->
                                                </div>
                                            </div>
                                            <div class="">
