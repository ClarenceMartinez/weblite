...
<head>
        <meta charset="utf-8">
        <title>
            <?php echo TITULO_PLANTA_INTERNA?>
        </title>  
    ...
    <body class="<?php echo ESTILO_BODY ?>">
            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">                 
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group"> <!-- col s12 m10 offset-m1 -->
                                    <h3 class="header">REGISTRO DE OBRA</h3>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-5">
                                        <div class="row form-group">
                                            <div class="col-sm-6 col-md-6">
                                                <label>Fase</label>
                                                <select class="select2" id="cmbFase" aria-label="usertype">
                                            ...
                                            <div class="input-group col-sm-6 col-md-6 ">
                                                ...
                                                <select class="select2" id="cmbProyecto" aria-label="usertype" onchange="getCmbSubProyectoByProyectoReg();">
                                        ...
                                        <div class="row form-group">
                                            <div class="input-group col-sm-6 col-md-6">
                                                ...
                                                <select class="select2" id="cmbSubProyecto" aria-label="usertype">
                                                    <option selected="">Seleccionar SubProyecto</option>
                                                </select>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input id="txtNombrePlan" type="text" class="form-control" placeholder="Ingresar Nombre Plan" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-sm-6 col-md-6">
                                                <label>Fecha Prev. Ejecución</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control date_picker" placeholder="Fecha Prev. Ejecución" id="fechaPrevEjec">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control date_picker" placeholder="Fecha Inicio" id="fecha_inicio">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text fs-xl">
                                                            <i class="fal fa-calendar-plus"></i>
                                                        </span>
                                        ...
                                        <div class="row form-group">
                                            <div id="contUip" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>UIP</label>
                                                <input id="txtUip" type="text" class="form-control" placeholder="Ingresar UIP" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div>
                                            <div id="contCmbItemMadre" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>Itemplan Madre</label>
                                                <select class="select2" id="cmbItemplanMadre" aria-label="usertype">
                                                </select>
                                            </div>
											<div id="contImpacto" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>Impacto</label>
                                                <input id="txtImpacto" type="text" class="form-control" placeholder="Ingresar Impacto" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div>
                                            <div id="contDivCau" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>DivCau</label>
                                                <select class="select2" id="cmbDivCau" aria-label="usertype">
                                                    <option selected="">Seleccionar DivCau</option>
                                                </select>
                                                <div class="invalid-tooltip">
                                                    Seleccionar DivCau.
                                                </div>
                                        ...
                                        <div class="row form-group">
                                            <div id="contCmbEmpElec" class="col-sm-6 col-md-6" style="display:none">
                                                <label>EECC Eléctrica</label>
                                                <select class="select2" id="cmbEmpElec" aria-label="usertype">
                                                </select>
                                            </div>                                            
                                            <div id="contIndicador" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>Indicador</label>
                                                <input id="txtIndicador" type="text" class="form-control" placeholder="Ingresar Indicador" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div> 
                                        </div>
                                        <div class="row form-group">
                                            <div id="contCostoMoPro" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>Costo MO</label>
                                                <input id="txtCostoMo" type="number" class="form-control" placeholder="Ingresar Costo MO" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div>
                                            <div id="contCostoMatPro" class="col-sm-6 col-md-6 form-group" style="display:none">
                                                <label>Costo Mat</label>
                                                <input id="txtCostoMat" type="number" class="form-control" placeholder="Ingresar Costo Mat" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            </div>
                                            <div id="contFechaPrevFo" class="col-sm-6 col-md-6" style="display:none">
                                                <label>Fecha Prev. de atención FO</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control date_picker" placeholder="Fecha Inicio" id="fecha_prev_fo">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text fs-xl">
                                                            <i class="fal fa-calendar-plus"></i>
                                                        </span>
                                    ...
                                    <div class="col-md-7">
                                        <div class="col-sm-12 col-md-12 form-group">
                                            ...
                                            <input id="pac-input" placeholder="Buscar" class="form-control container col-md-6 col-sm-6" type="text">
                                            <!-- <input id="pac-input" class="controls" type="text" placeholder="Buscar"> -->
                                            <div id="divMapCoordenadas" class="d-flex flex-row w-100 py-4"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-3">
                                        ...
                                        <input id="txtLongitud" type="text" class="form-control" placeholder="Longitud" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Latitud</label>
                                        <input id="txtLatitud" type="text" class="form-control" placeholder="Latitud" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    <!--
                                    <div class="col-md-3">
                                        <label>EECC</label>
                                        <input id="txtEmpresaColab" type="text" class="form-control" placeholder="EECC" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>-->
                                    <div class="col-md-3">
                                        <div id="contcmbEecc">
                                            <label>EECC</label>
                                            <select class="select2" id="cmbEecc" aria-label="usertype" onchange="changeEeccRegItem()" disabled>
                                            <option selected="">Seleccionar EECC</option>
                                                <?php echo $cmbEecc?>
                                            </select>
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div id="contcmbCentral">
                                            <label>CENTRAL</label>
                                            <select class="select2" id="cmbCentral" aria-label="usertype" disabled>                                       
                                                <?php echo $cmbCentral?>
                                            </select>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="col-md-3">
                                        <label>Central</label>
                                        <input id="txtCodigoCentral" type="text" class="form-control" placeholder="Código Central" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    -->
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-3">
                                        <label>Código de Inversión</label>
                                        <select class="select2" id="cmbInversion" aria-label="usertype">
                                            <option selected="">Seleccionar Código de Inversión</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row">
                                    <button class="btn btn-primary ml-auto" type="buttom" onclick="registrarItemplan();">Registrar Itemplan</button>
                                </div>
                            </div>
                        </div>
                    </main>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_utils/jsRegistroItemplan.js?v=<?php echo time();?>"></script>
