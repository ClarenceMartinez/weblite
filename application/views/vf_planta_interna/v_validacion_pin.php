...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
        ...
        <div class="modal fade modal-fullscreen-lg-down" id="mdlPoPin" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="settings-panel">
                            <div id="contPo" class="form-group">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade modal-fullscreen-lg-down" id="mdlCotizacionPin" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <script src="<?php echo base_url(); ?>public/js/js_planta_interna/jsValidacionPin.js?v=<?php echo time();?>"></script>
        <script>
            ...
            initDataTableModal('mdlCotizacionPin', 'tbKitPartida');
        </script>
    </body>
    <!-- END Body -->
</html>
