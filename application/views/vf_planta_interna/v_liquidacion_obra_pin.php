...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Liquidación PIN</li>
                        </ol>
                        <div class="subheader">
        ...
        <div class="modal fade" id="mdlLiquidacionObraPin" tabindex="-1" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content" style="width: 1300px;">
                    <div class="modal-header">
                        <h5 class="modal-title">LIQUIDACIÓN OBRA</h5>
                    ...
                    <div class="modal-body">
                        <div id="panel-12" class="panel">
                            <div class="panel-hdr">
                                <h2>
                                    Estaciones <span class="fw-300"><i>-</i></span>
                                </h2>
                            </div>
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="row" id="contTabLiquidacion">
                    ...
                    <div class="modal-footer">
                        <button id="btnProcesar" type="button" class="btn btn-primary" onclick="liquidarObra();">Guardar</button>
