...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                            ...
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr form-group">
                                        <h2>
                                                APROBACION COTIZACION PLANTA INTERNA
                                        </h2>
        ...
        <div id="mdlDetalleItemPlan" class="modal fade" role="dialog" aria-hidden="true" style="padding-right: 150px;">
            <div class="modal-dialog modal-lg ">
                <div class="modal-content " style="width: 80em;">
                    ...
                    <div class="modal-body container">
                        <div class="settings-panel">
                            <div id="contTablaKitPartidadetalle" class="form-group">
                            </div>
                            <div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_planta_interna/jsBandejaAprobacion.js?v=<?php echo time();?>"></script>
        <script>
