                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="selectContrata" name="selectContrata" class="select2" >
                                                            <option value="">&nbsp;</option>
                                                            <?php
                                                            foreach ($empresaColaboradora as $row) {
                                                                ?> 
                                                ...
                                                <div class="col-sm-3 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="selectMes" name="selectMes" class="select2" >
                                                                <option value="">&nbsp;</option>
                                                    ...
                                                    <div style="margin-top: 20px;">
                                                        <div class="form-group">
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <button class="btn btn-success" style="margin-right: 20px;" type="button" onclick="filtrarTabla()" id="btnProceso1">Proceso de Evaluaci&oacute;n</button>
        ...
        <div class="modal fade" id="modalItemplanHijos"  tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" id="itemPlanPE">
