...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
        ...
        <script src="<?php echo base_url(); ?>public/js/js_reportes/jsDashboard.js?v=<?php echo time();?>"></script>
        ...
        <script>
            $(document).ready(function()
            {
                ...
                $('.searchT').on('click', function() {
                    ...
                    $.ajax({
                     ...
                     //   console.log(myObj);
                      //  console.log(myObj.serie);
                        drawColumChart('container', myObj.serie, myObj.drillDrwon);
                        drawColumChartUIP('container2', myObj.serieuip, myObj.drillDrwonuip);
                    });
                });
            ...
            //'container'
        function drawColumChart(id, serie, dataDrill){
            console.log(serie);
        ...
        function drawColumChartUIP(id, serie, dataDrill){
            console.log(serie);
            console.log(dataDrill);
            Highcharts.chart(id, {
                chart: {
