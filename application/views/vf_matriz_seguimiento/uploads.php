                                        ...
                                        <div class="panel-content">
                                            <div class="row">
                                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <button type="button" class="btn btn-outline-primary waves-effect waves-themed" onclick="procesarFile(2)" id="btnProcesar">
                                                ...
                                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                                    <button class="btn btn-primary ml-auto waves-effect waves-themed" type="button" onclick="cargarFile(2)" id="btnRegPO" style="margin-top: 25px;color:white">REGISTRAR VALORES</button>
                                                </div>
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <a onclick="exportarFormatoCargaMatrizSeguimiento(2)" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                                </div>
                                            </div>
                                            <div class="">
                                                <div class="row">
