...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content"> 
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-4 col-lg-9 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">REGISTRO MASIVO SOLICITUD COTIZACION B2B</label>                                        
        ...
        <script type="text/javascript">
            ...
            {
                initExistDataTableLight('tb_carga');
            });
                ...
                $.ajax({
                    ...
                    if(data.error == 0){
                        if(data.archivo != null && data.archivo != undefined){
                            ...
                            $("body").append($a);
                            $a.attr("download","FORMATO REGISTRO SOLICITUD COTIZACION B2B.xls");
                            $a[0].click();
                            $a.remove();
                        }
                    }else{
