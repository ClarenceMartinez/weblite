                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">            
                                            ...
                                            <div class="row" style="-20px;">                                              
                                             ...
                                             -->
                                            <div class="row" style="margin-top: -20px;-20px;">
                                                <div class="col-6 col-lg-6">
                                                    <p class="m-3">  
                                                    <label >Rango Fecha Aprobacion Cotizacion</label>
                                                        <div style="margin-top: -16px;" class="input-daterange input-group" id="datepicker-5">
                                                            <input id="fec_ini" type="text" class="form-control" name="start">
                                                            <div class="input-group-append input-group-prepend">
                                                                <span class="input-group-text fs-xl"><i class="fal fa-ellipsis-h"></i></span>
                                                            </div>
                                                            <input id="fec_fin" type="text" class="form-control" name="end">
                                                         
                                                            <a style="margin-left: 15px; " class="btn btn-md btn-outline-primary waves-effect waves-themed searchT">
                                                                <span class="fal fa-search mr-1"></span>
                                                                Buscar
                                                            </a> 
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-sm table-hover table-striped w-100">
                                                    <thead class="bg-primary-600"">
                                                        ...
                                                        <th>ESTADO</th>
                                                        <th>CANT PUNTOS DE APOYO</th>
                                                        <th>OPERADOR PUNTOS DE APOYO</th>
                                                        <th>CANT. POSTES ELECTRICOS</th>
                                                        <th>EMPRESA ELECTRICA</th>
                                                        <th>METROS DUCTO 2"</th>
                                                        <th>METROS DUCTO 3"</th>
                                                        <th>METROS DUCTO 4"</th>
                                                        <th>OPERADOR SUBTERRANEO</th>
                                                    </thead>                                               
                                                </table>  
                                        </div>
                                    </div>
                    ...
                    allowOutsideClick: false
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                ...
                                var data = JSON.parse(data);                                
                                 if(data.error == 0){
                                    mostrarNotificacion(1, 'success', 'Se rechazo la cotizacion correctamente', 'Verificar');
                                }else{
                                    mostrarNotificacion(1, 'error', data.msj, 'Verificar');
                                }
