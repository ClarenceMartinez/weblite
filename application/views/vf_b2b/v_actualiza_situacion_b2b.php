...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content"> 
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-3 col-lg-9 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">ACTUALIZACION DE SITUACION B2B</label>                                        
                                        
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="archivo" id="archivo" accept="application/vnd.openxmlformats-offedocument.spreadsheetml.sheet., application/vnd.ms-excel,application/vnd.msexcel,application/excel" aria-describedby="inputGroupFileAddon04">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <a onclick="descargarFormatoExcel()" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                        <br>
                                        (*) El sistema solo reconocera situaciones válidas, Puede descargar la lista de situaciones válidas.
                                        <a href="<?php echo  base_url().'download\b2b\FORMATO_SITUACIONES_VALIDAS_EECC.xlsx' ?>" style="color: #e9426e;cursor: pointer;">Aquí</a>
                                    </div>
                                </div>
                        </div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <div id="contTabla">
                                                <table id="tb_carga" class="table table-bordered table-hover table-striped w-100">
        ...
        <script type="text/javascript">
            ...
            {
                var tbGlob = initDataTable('tb_carga');
            });
                ...
                $.ajax({
                    ...
                    if(data.error == 0){
                        if(data.archivo != null && data.archivo != undefined){
                            ...
                            $("body").append($a);
                            $a.attr("download","FORMATO_ACTUALIZACION_SITUACION_B2B.xls");
                            $a[0].click();
                            $a.remove();
                        }
                    }else{
                ...
                swal.fire({
					...
					if (result.value) {
						...
						$.ajax({
                            ...
                            $('body').loading('destroy');
							if(data.error == 0){
                                $('#contTabla').html(data.tablaItem);
                                initDataTable('tb_carga');
