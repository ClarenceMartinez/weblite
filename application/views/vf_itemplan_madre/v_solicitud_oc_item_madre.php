...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itemplan_madre/jsSolicitudOcItemMadre.js?v=<?php echo time();?>"></script>
        <script>
            $(document).ready(function()
            {
                var json = <?php echo json_encode($json_bandeja)?>;
                console.log(json);
                initTableLight(<?php echo json_encode($json_bandeja)?>);
			    //filtrarSolicitudOC();
                //initDataTable('tbSolicitudOc',3);
            });
            initDataTableModal('mdlDetalleSolicitud', 'tbDetalleSolicitudOc');
            initDataTableModal('mdlAtenderSolicitud', 'tbAtenderSolicitudOc');
        </script>
    </body>
    <!-- END Body -->
</html>
