...
<head>
    ...
    <body class="<?php echo ESTILO_BODY ?>">
                            ...
                            <div class="card-body">                               
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="input-group col-md-4">
                                        ...
                                        <select class="select2" id="cmbProyecto" aria-label="usertype" onchange="getCmbSubProyectoByProyecto();">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control date_picker" placeholder="Fecha Recepción" id="fecha_recepcion">
                                    ...
                                    <div class="col-md-3">
                                        <label>UIP</label>
                                        <input id="txtUip" type="text" class="form-control" placeholder="cant. UIP" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Nombre Cliente</label>
                                        <input id="txtCliente" type="text" class="form-control" placeholder="Nombre Cliente" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-3">
                                        ...
                                        <input id="txtDepa" type="text" class="form-control" placeholder="Departamento" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        <label>PROVINCIA</label>
                                        <input id="txtProv" type="text" class="form-control" placeholder="Provincia" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        <label>DISTRITO</label>
                                        <input id="txtDis" type="text" class="form-control" placeholder="Distrito" aria-label="Recipient's username" aria-describedby="basic-addon2" disabled>
                                    </div>
                                    <div class="col-md-3">
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itemplan_madre/jsRegistrarItemplanMadre.js?v=<?php echo time();?>"></script>
