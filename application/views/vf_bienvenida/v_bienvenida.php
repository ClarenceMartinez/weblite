                    ...
                    <main id="js-page-content" role="main" class="page-content">                      
                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                            <div class="row form-group">
                                <div class="col-md-6">
                                    <h3 class="mb-g" style="font-weight: 900;">
                                        BIENVENIDO
                                    </h3>
                                    <p>
                                        Te encuentras en la plataforma de gestion de Obras de PangeaCo.
                                    </p>
                                    <p>
                                        La plataforma cuenta con las siguientes funcionalidades:
                                        <ui>
                                            <li>Registro de Obra</li>
                                            <li>Gestion de Orden de Compra</li>
                                            <li>Ejecucion de diseño</li>
                                            <li>Ejecucion de licencia</li>
                                            <li>Gestion de Vale de Reserva</li>
                                            <li>Liquidacion de obra</li>
                                            <li>Validacion de obra</li>
                                            <li>Certificacion</li>
                                        </ui>
                                    </p>
                                    <p>
                                        Esperamos que la experiencia con la plataforma sea de su agrado.
                                    </p>
                                    <p>
                                        PangeaCo @ 2023<br>
                                    </p>
                                ...
                                <div class="col-md-6" style="text-align: center;">                                 
                                    <img src="<?php echo base_url();?>public/img/internas/tecnico.jpg" alt="Fibra" style="width: 100%;  height: 100%;">
                                </div>
                            </div>
                        </div>
                     </main>
