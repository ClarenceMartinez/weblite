...
@media (max-width: 992px) {
            ...
            <div class="page-inner">
                ...
                <aside class="page-sidebar">               
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img id="imgLogo" src="<?php echo base_url(); ?>public/img/demo/avatars/avatar-m.png" class="profile-image rounded-circle">
                        ...
                        <div id="panel-11" class="panel">
                            <div class="panel-hdr">
                                    ...
                                    <h1 class="subheader-title">
                                       Panel  <?php echo $informacion_vista ?>
                                    </h1>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content">
              <h3>Bienvenido al módulo de <strong><?php echo $informacion_vista ?></strong></h3>
              <p style="text-align: justify;">
                Contiene muchas opciones, el menú es muy accesible según el perfil que tiene.
              </p>
              <p>
  ...
  <div class="card-body"><img src="<?php echo RUTA_IMG_INTERNAS?>img1.jpg" class="card-img-top"  alt="..." style="border-radius: 10em;"></div>
  <div class="card-footer"><button type="button" class="btn" style="background-color: #3f871a;color: #fff;width: 100%;">Boton 1</button></div>
</div>
    </div>
        <div class="col-sm">
            <div class="card">
                <div class="card-body"><img src="<?php echo RUTA_IMG_INTERNAS?>img1.jpg" class="card-img-top"  alt="..." style="border-radius: 10em;"></div>
                    <div class="card-footer"><button type="button" class="btn" style="background-color: #3f871a;color: #fff;width: 100%;">Boton 2</button></div>
                    </div>
                </div>
                <div class="col-sm">
                    <div class="card">
                    <div class="card-body"><img src="<?php echo RUTA_IMG_INTERNAS?>img1.jpg" class="card-img-top"  alt="..." style="border-radius: 10em;"></div>
                        <div class="card-footer"><button type="button" class="btn" style="background-color: #1c3269;color: #fff;width: 100%;">Boton 3</button></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style="background-image: url(public/img/internas/<?php echo $informacion_banner?>);">&nbsp;</div>
        </div>
        ...
        <div id="mdlDetalleSolicitud" class="modal fade" role="dialog" aria-hidden="true">
