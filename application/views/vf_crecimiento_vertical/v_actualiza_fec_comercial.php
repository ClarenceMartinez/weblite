                        ...
                        <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">                                
                            <div class="row">                          
                                    <div class="form-group col-xl-3 col-lg-9 col-md-6 col-sm-12 col-12">
                                        <label class="form-label" for="inputGroupFile01">ACTUALIZACION FECHA DE ENTREGA A COMERCIAL</label>                                        
                ...
                $.ajax({
                    ...
                    if(data.error == 0){
                        if(data.archivo != null && data.archivo != undefined){
                            ...
                            $("body").append($a);
                            $a.attr("download","FORMATO_ACTUALIZACION_FECHA_ENTREGA_COMERCIAL.xls");
                            $a[0].click();
                            $a.remove();
                        }
                    }else{
